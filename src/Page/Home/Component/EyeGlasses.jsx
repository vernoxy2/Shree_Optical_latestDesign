        ...
        <div className="hidden lg:block">
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="flex flex-row items-stretch gap-8">
              ...
              <div className="w-1/2 bg-white rounded-2xl flex flex-col items-start justify-center p-16 gap-12 shadow-sm relative overflow-hidden">
                <div className="absolute -top-10 -right-10 w-40 h-40 bg-primary/5 rounded-full blur-3xl" />

                <h3 className="text-primary font-black font-nunito text-7xl text-left">
                  {item.type}
                </h3>

                <div className="w-full flex items-center justify-start py-4 hover:scale-105 transition-transform duration-500">
                  <img
                    src={item.glassesImg}
                    alt={item.type}
